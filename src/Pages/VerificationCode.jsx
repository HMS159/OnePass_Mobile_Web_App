          ...
          <div className="flex flex-col h-full">
            ...
            <div className="text-center px-4 mb-8">
              ...
              <p className="text-sm text-gray-500 leading-relaxed">
                Verify your Aadhaar securely to continue. The verification
                process is encrypted and direct.
              </p>
            </div>
            ...
            <div className="bg-gray-50 border border-gray-100 rounded-lg p-5 flex items-start gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mt-1 leading-relaxed">
                  Have your Aadhaar number and registered mobile phone ready for
                  OTP.
                </p>
              </div>
            </div>
