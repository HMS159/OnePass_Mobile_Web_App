...
import { Check, X, Building2, Calendar, MapPin, ArrowRight } from "lucide-react";
        ...
        <div className="w-full h-dvh bg-[#F7F7F7] px-4 py-10 flex flex-col items-center">
            ...
            <div className="w-full bg-white rounded-3xl p-8 shadow-xl shadow-black/5 relative overflow-hidden">
                ...
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-[#1b3631] mb-3">Verification done</h1>
                    <p className="text-sm text-gray-500 leading-relaxed">
                        Your identity has been successfully verified. You are now authorized for entry.
                    </p>
                </div>
                ...
                <div className="bg-gray-50 rounded-2xl p-5 space-y-4 border border-gray-100 mb-8 text-left">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm font-bold text-[#1b3631]">Microsoft Office, Block A</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Entry Time</p>
                            <p className="text-sm font-bold text-[#1b3631]">Today, 10:30 AM</p>
                        </div>
                    </div>
                </div>
